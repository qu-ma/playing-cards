...
public class Trick {
  ...
  public static void main(String[] args) {
    ...
    // TODO Draw cards from the deck until none remain, and split the cards into red and black piles.
    ...
    // TODO Tally count of red cards in red pile, black cards in black pile, and print the results.
  ...
  private static void swapCards(Random rng, List<Card> blackPile, List<Card> redPile) {
    int swapCount = rng.nextInt(1 + Integer.min(blackPile.size(), redPile.size()));
